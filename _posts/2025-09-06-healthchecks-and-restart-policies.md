...
description: "Why is a container marked running while the process inside it is stuck? `docker ps` only reports whether a container's PID 1 process is still alive, n..."
---
