...
description: "How do you update your database AND notify other services without ever losing one? The transactional outbox pattern writes the event to an outbox tabl..."
---
