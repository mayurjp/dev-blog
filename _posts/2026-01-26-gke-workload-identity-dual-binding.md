...
description: "Why does a GKE Pod need two separate bindings to call a GCP API without a downloaded key file? Workload Identity requires an IAM binding granting the ..."
---
