...
excerpt: ""
description: "Why does one workflow need two different ways to pass a value between steps  one for steps, another for jobs? Steps in the same job share a runner, so..."
---
{% raw %}
