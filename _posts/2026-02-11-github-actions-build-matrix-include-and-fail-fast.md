...
excerpt: ""
description: "Why does one failed OS in a build matrix sometimes cancel every other OS's tests? GitHub's default `fail-fast: true` behavior cancels every other in-p..."
---
{% raw %}
