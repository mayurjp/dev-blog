...
description: "If a domain event handler fails, does the order status change still get saved? No — domain events are dispatched right before `SaveChanges`, in the sa..."
---
