...
description: "Why does `AndSpecification` evaluate its right side even after its left side already fails? Because it doesn't short-circuit like `&&` on purpose — a ..."
---
