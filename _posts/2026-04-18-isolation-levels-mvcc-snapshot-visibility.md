...
description: "How does Postgres decide whether your transaction can see a row someone else just committed? It checks the row version's creating transaction ID again..."
---
