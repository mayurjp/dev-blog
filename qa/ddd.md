...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What problem does ubiquitous language solve that a glossary document can't? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why are domain events named in past tense rather than as commands? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: When would you use Event Storming vs. just interviewing domain experts? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What is the common mistake when adopting ubiquitous language? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does `SetShippedStatus()` enforce a business rule that `order.Status = 5` cannot? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens if the same business event uses different names across services? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What problem does the Entity/Value Object distinction solve? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does Entity equality differ from Value Object equality at the implementation level? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens if two unsaved (transient) entities are compared using the default Id-based equality? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What is the gotcha with implementing Value Objects using C# `record` vs. hand-written `class`? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: When would you use a Value Object instead of an Entity? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What is the tradeoff of using a Value Object for a concept that might later need identity? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What problem does the aggregate boundary solve? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How is the aggregate boundary enforced at the language level in eShop? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens if two aggregate roots are mutated in the same transaction? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What is the common mistake when using the term "aggregate"? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does `IAggregateRoot` have zero members? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Compare the merge logic in `AddOrderItem` — why is keeping the higher discount a business decision, not a technical one? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What problem does dispatching domain events *before* `SaveChanges` solve? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does `SaveEntitiesAsync` in eShop find and dispatch pending domain events? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens if a domain event handler throws an exception? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How do domain events differ from integration events in eShop? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why is `ClearDomainEvents()` called *before* `mediator.Publish`, not after? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What is the tradeoff of dispatching domain events after commit instead of before? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What does an application service do that a domain service does not? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: How does eShop actually implement the "which orders exceeded their grace period" policy? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What is the risk of the grace-period logic living in a raw SQL string? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: Compare the command handler's role vs. the aggregate's role in `CreateOrderCommandHandler`. <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens if you put business rules in the application service instead of the aggregate? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why might a team choose raw SQL over a domain service for cross-aggregate policy? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What problem does restricting repositories to aggregate roots solve? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does `GetAsync` ensure the caller never receives a partial aggregate? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What is the gotcha with relying on EF Core lazy loading inside a repository? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does `Update` just flip EF Core's entity state to `Modified` instead of doing field-by-field diffing? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does the `UnitOfWork => _context` assignment relate to domain event dispatch? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What is the tradeoff of having no generic `Repository<T>` for internal types like `OrderItem`? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What problem does a static factory method like `Order.NewDraft()` solve that a constructor can't? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What does `NewDraft()` intentionally omit that the real constructor includes? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens if a draft order accidentally gets passed to `IOrderRepository.Add`? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why do both construction paths converge on the same `AddOrderItem` method? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: Does a DDD factory require a separate `OrderFactory` class with an `IFactory<T>` interface? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What is the tradeoff of raising a domain event inside a constructor vs. returning it separately? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What problem does the specification pattern solve that ad hoc `if` chains don't? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does `AndSpecification` evaluate both sides unconditionally instead of short-circuiting? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens if you use the parameterless `Not()` instead of `Not(errorFactory)`? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does `ValidationResultCollector` walk the specification tree? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: Compare a boolean-only specification with one that supports visitor-based error collection. <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What is the tradeoff of unconditional evaluation in `AndSpecification`? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What problem does each consumer defining its own copy of an integration event solve? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does a Published Language relationship differ from a Conformist one? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: How many independently-declared classes represent "order paid" in eShop, and why isn't that duplication? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What links these four event classes at the type-system level? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What is the gotcha with thinking context mapping is a single dropdown selection per pair of bounded contexts? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens if Catalog.API directly referenced Ordering's `OrderStatusChangedToPaidIntegrationEvent` type? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What problem does event sourcing solve that traditional state storage doesn't? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What does `Emit()` do atomically, and why is this important? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens during replay if an event's `AggregateSequenceNumber` isn't exactly `Version + 1`? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does snapshotting bound replay cost? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: Does event sourcing require CQRS? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What is the tradeoff of snapshotting frequency? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What is the real test for whether a domain model is rich or anemic? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does `CurrentValues.SetValues(productToUpdate)` bypass the domain model's invariants? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What is the tradeoff of having a public setter on `AvailableStock` vs. making it `private set`? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does the same repository demonstrate both rich and anemic models simultaneously? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What is the common mistake when checking if a class has a rich domain model? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why isn't `CatalogItem`'s anemic model necessarily a bug? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why are input validation and business invariant enforcement two separate layers? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does `ValidatorBehavior` in eShop's MediatR pipeline enforce input validation? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What check can `OrderItem`'s constructor enforce that FluentValidation cannot? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens if the invariant layer is the only validation layer? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why do both validation layers throw the same `OrderingDomainException` type? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What is the gotcha of treating validation as a single, undifferentiated concern? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: Compare the two layers: when does each run, and what does each know? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
