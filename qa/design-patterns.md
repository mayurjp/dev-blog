...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What problem does the Strategy pattern solve that an enum + switch statement doesn't? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does Polly's `ResilienceStrategy` abstract differ from a typical textbook Strategy interface? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does `ShouldHandle` in Polly's retry strategy take a delegate rather than a hardcoded exception type? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens if the context class in a Strategy pattern contains an `if (strategy is RetryStrategy)` check? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What's a common gotcha when designing the Strategy interface in a resilience library? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: When would you choose Strategy over simply subclassing the context class? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What does `IDbContextFactory<T>` hide that a `new DbContext(options)` call never could? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does EF Core's `PooledDbContextFactory` make `Dispose()` mean something different? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What tradeoff does a pooled factory introduce compared to a plain factory? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does even EF Core's "plain" `DbContextFactory` use a cached delegate instead of `new TContext(...)` directly? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does switching from a plain factory to a pooled factory work in a real EF Core app? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What's the relationship between Factory Method and Abstract Factory in modern practice? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What is a "captive dependency" and why does it cause silent data corruption? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does ASP.NET Core's DI container detect captive dependencies? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens if a scoped service is deeply nested in a singleton's dependency tree (not a direct parameter)? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: When is a Singleton lifetime actually appropriate in a DI-based system? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does the CallSiteValidator cache its results per `callSite.Cache.Key`? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What's the gotcha with the CallSiteValidator's `argument.Singleton` threading mechanism? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What problem does copy-on-Write solve for the Observer pattern that a lock around the notification path doesn't? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does Rx.NET's `Subject<T>` handle an observer subscribing after the stream has already terminated? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does Rx.NET use two separate sentinel arrays (`Terminated` and `Disposed`) instead of sharing one empty array? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens if two threads subscribe concurrently — does one observer get lost? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why is the `Interlocked.CompareExchange` retry loop intentionally unbounded? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What's the common mistake when implementing Observer in a concurrent system? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does nesting order change behavior when composing a retry with a circuit breaker in Polly? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What's the mechanism that makes policy composition work in Polly's `WrapAsync`? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does Polly need four separate `WrapAsync` overloads instead of one generic "wrap anything in anything" method? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does modern Decorator differ from the textbook GoF class-wrapping version? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: When would you use Decorator instead of Strategy for cross-cutting concerns? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What's a common mistake when reordering decorators? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does Django's `BaseDatabaseOperations` qualify as an Adapter rather than a Facade? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What does Oracle's `quote_name` adapter do that makes it more than a simple character swap? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does every concrete `quote_name` in Django check if the name is already quoted before re-wrapping? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does `BaseDatabaseOperations.quote_name` raise `NotImplementedError` instead of providing a default? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens if a new Django backend is added but forgets to implement `quote_name`? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why is the Command pattern in Redis valuable beyond its classic undo/redo use case? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What role does the `redisCommand` struct play beyond holding a function pointer? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does Redis wrap `CLIENT_EXECUTING_COMMAND` flag-setting around the single dispatch line? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What's the gotcha with using a giant if/else dispatch instead of the Command pattern? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: When does the Command pattern become overkill versus a simple strategy dispatch? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does Redis's command table differ from a switch-based dispatch in terms of extensibility? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does every EF Core builder method return `this` instead of void? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What problem does the immutable-extension-swap inside EF Core's builder solve? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does `WithOption` in `DbContextOptionsBuilder` handle the very first configuration call? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: Where does the actual immutable-update logic live — on the builder or on the extension? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why is the fluent builder pattern superior to a constructor with dozens of optional parameters? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What's a common mistake when implementing fluent builders? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: How does a DI container decide which constructor to call when a class has three constructors? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens when two constructors require genuinely different, non-overlapping sets of resolvable services? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does the circular dependency detection turn a stack overflow into a readable error? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does `CallSiteChain` use `_callSiteChain.Count` at insertion time instead of dictionary iteration order? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does `CallSiteChain` have both `Add` and `Remove` methods? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What's a common mistake that triggers an ambiguous-constructor exception? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does eShop wrap EF Core's `DbSet<T>` in an `IOrderRepository` layer? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Where does `IOrderRepository` live and why does that placement matter? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does the Repository pattern pair with Unit of Work in eShop? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What is the one line in `OrderRepository.GetAsync` that justifies the repository's existence? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: When is the Repository pattern *not* worth adding? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What's a common gotcha when a developer adds a Repository on top of EF Core? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does Polly's circuit breaker have a 4th state (Isolated) that most textbooks skip? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens to an in-flight call's result when the circuit transitions from Closed to Open mid-flight? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: How does `HalfOpen` avoid immediately re-overwhelming a recovering dependency? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why is the "should break" decision delegated to a separate `_behavior` object rather than hardcoded in the state machine? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What's the practical difference between Open and Isolated states in error-handling code? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: When would you manually Isolate a circuit instead of waiting for it to trip automatically? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What's the common mistake when implementing a circuit breaker? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does ASP.NET Core build its middleware pipeline backwards instead of forwards? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What does the terminal `RequestDelegate` in ASP.NET Core's pipeline do when a request reaches it? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why are registration and construction deliberately separate phases in ASP.NET Core's middleware pipeline? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does `_components[c](app)` make the `next` parameter mean "the rest of the pipeline"? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens to execution order when you use conditional branching (`MapWhen`, `UseWhen`) in the pipeline? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What's the common mistake when debugging middleware execution order? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: When would you use Chain of Responsibility instead of Decorator for composing behaviors? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
