...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What problem does multi-cloud solve, and why isn't "avoiding lock-in" usually a sufficient driver? <span class="qa-badge qa-expert">[Expert]</span></h3>
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does AWS RDS's `multi_az` field differ structurally from GCP Cloud SQL's `availability_type`? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What is the ongoing engineering cost of multi-cloud that most tutorials skip? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: Can a well-written Terraform module eliminate the schema divergence between AWS and GCP resources? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens when a team assumes `backup_retention_period` on AWS and `retained_backups` on GCP are interchangeable? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What problem does Terraform's provider protocol solve for multi-cloud? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: How does Terraform Core avoid compile-time coupling to any specific cloud's resource schema? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What makes it possible for Terraform to support 3,000+ providers without an equally large switch statement in Core? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why is each Terraform provider a separate OS process rather than a library linked into Core? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: When debugging a plan/apply discrepancy for a specific resource, is the bug more likely in Terraform Core or in the provider? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does Terraform handle state upgrades when a provider changes a resource's schema? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why doesn't a Kubernetes ServiceAccount granting cloud IAM permissions work identically on GKE and EKS? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What per-cluster prerequisite does AWS IRSA require that GKE Workload Identity does not? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens if the OIDC provider ARN in an IRSA trust policy doesn't match the actual cluster's issuer URL? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does AWS IRSA's `aud` (audience) condition differ from anything in GKE Workload Identity? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: Is the migration of a workload's cloud-IAM binding from EKS to GKE just a matter of changing the annotation value? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: Does application code need to know which cloud's identity mechanism is in use? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What is the three-layer object model in Crossplane that bridges a developer's YAML claim to actual cloud resources? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What role does the Composition's gRPC function pipeline play in Crossplane? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why doesn't updating a Composition instantly affect all running Claims? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: How does Crossplane avoid loading watches for every possible cloud resource type at startup? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What does Crossplane's circuit breaker do and when does it trigger? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What is the `BetaFallBackFunctionRunnerServiceClient` and why does it exist? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens if a Composition only patches into Managed Resources but never patches back to the Claim? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What are the three distinct mechanisms Consul uses for multi-cloud networking, and what does each handle? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What does the `PeerThroughMeshGateways` boolean in MeshConfigEntry control? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens after peering is established but before `exported-services` is configured? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: Can a team use both WAN federation and peering for the same pair of datacenters? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What is a `PeeringToken` and what does it contain? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What fails silently if the `exported-services` entry has a typo in the peer name? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What are the three failure modes of storing long-lived AWS access keys as GitHub Actions secrets? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What must the OIDC provider's `client_id_list` include for GitHub Actions OIDC federation to work? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does Terraform retry role creation when using OIDC federation? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens if you use a `*` wildcard in the trust policy's `sub` condition in production? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why is the `thumbprint_list` empty for GitHub's OIDC provider? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: Where does the S3 compatibility abstraction break when using MinIO across clouds? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does MinIO use "dummy call" handlers (GetBucketACL returning empty 200) instead of returning 401/403? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What does MinIO's `rejectedObjAPIs` and `rejectedBucketAPIs` list represent? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why is the `ObjectInfo` struct in MinIO not cloud-portable? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What is a gotcha when using MinIO's extension APIs in cloud-agnostic code? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does CoreDNS resolve multi-cluster service names differently from single-cluster names? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens if the `fallthrough` directive is omitted from the CoreDNS Corefile for a multi-cluster zone? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does plugin ordering in the Corefile matter? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What is the difference between `multicluster` and `forward` for cross-cluster DNS? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens at startup if `multicluster` is set in the Corefile but the MCS API CRDs are not installed? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does Istio need east-west gateways for multi-cluster across cloud VPCs? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What does the `EndpointsByNetworkFilter` in Istio's endpoint builder actually do? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What is the `forceGateway` edge case in `EndpointsByNetworkFilter` and why does it matter? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does `selectNetworkGateways` prefer gateways in the same cluster as the target endpoints? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does the ambient (non-sidecar) mode differ from sidecar mode in the gateway endpoint's wire protocol? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What is the common misconfiguration that causes cross-cluster traffic to fail silently? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why can't AWS Cost Explorer tell you which Kubernetes namespace consumed 400 CPU-core-hours of EC2 spend? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does OpenCost's allocation engine compute per-namespace costs? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why do OpenCost's Prometheus collectors read from an in-memory `ClusterCache` rather than depending on kube-state-metrics? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens if a node's Spot price changes mid-allocation window? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does `ComputeAllocation` batch Prometheus queries into windows instead of querying the full range at once? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why can't you run a single etcd cluster stretched across two clouds for unified multi-cloud state? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What does etcd's lessor (lease manager) do that makes a stretched cluster particularly bad? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What is the production pattern for multi-cloud etcd, and what tradeoff does it accept? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why do cross-cloud network latencies of 10-80 ms cause problems for a stretched etcd cluster even without a full partition? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What is the RPO when using independent etcd clusters with async replication? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: Where does Terraform's real lock-in live — in HCL syntax or in the state file? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What is `Private []byte` in the state file and why is it the deepest lock-in mechanism? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does `terraform state pull` on a state file from another team sometimes download providers you don't use? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What is the practical escape hatch for cross-cloud migration in Terraform? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: Does OpenTofu's state format differ from Terraform's in ways that affect portability? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens if you downgrade a provider version after a schema bump that changed `SchemaVersion`? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
