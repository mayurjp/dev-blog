...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What are the three pillars of observability and what kind of question does each one answer? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does OpenTelemetry require three separate configuration calls instead of one to enable "observability"? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why would using a high-cardinality field (like user ID) in both a metric and a trace cause different problems in each? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: In eShop's OpenTelemetry config, why does `WithMetrics` register `AddRuntimeInstrumentation()` while `WithTracing` registers `AddGrpcClientInstrumentation()`? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens if you only configure the OTLP exporter for metrics but forget to wire it for logs? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does eShop's tracing config use `AlwaysOnSampler` only in development, and why doesn't the same concept apply to metrics? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What's the difference between `logger.LogInformation($"User {userId}")` and `logger.LogInformation("User {UserId}", userId)`? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why is `{OriginalFormat}` appended as an extra entry beyond the named placeholders? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does `LogValuesFormatter` extract field names — from the template string or from the rendered output? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why can't you just wrap a string-interpolated log message in JSON to make it "structured"? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens to format specifiers like `:C` in a placeholder like `{Price:C}` during structured logging? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What's the common mistake when teams say they've adopted "structured logging"? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How can a library add tracing instrumentation without knowing whether the application has configured a tracing backend? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What is `TracerProvider.Default` and why is it a static singleton rather than null? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why is `Tracer.ActivitySource` typed as nullable (`ActivitySource?`)? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What is `TelemetrySpan.NoopInstance` and when is it returned? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What problem does the API/SDK separation solve that direct vendor integration doesn't? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: If a library uses OpenTelemetry's API but the application never wires up an SDK, what overhead does the library incur? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What is the W3C `traceparent` header format? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why is version `ff` explicitly forbidden in the traceparent header? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why are all-zeros trace-id and parent-id rejected? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does the traceparent parser handle a future version of the W3C spec? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: Before the W3C standard existed, what happened when two services used different tracing vendors? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What's the gotcha with `IsInvalidTraceParent` returning `traceId = null`? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What is cardinality explosion in metrics? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does OpenTelemetry's SDK protect against cardinality explosion at runtime? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does `NumberOfMetricPoints = cardinalityLimit + 2` instead of just `cardinalityLimit`? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why is the overflow tag `otel.metric.overflow=true` initialized with a double-checked lock? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does `Interlocked.Increment(ref DroppedMeasurements)` run on *every* overflowed measurement, not just the first? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens to a metric with a user-ID tag in production when the cardinality limit is exceeded? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What's the common mistake when teams are told to "keep labels low-cardinality"? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why doesn't Loki index the words inside log lines? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does Loki's two-phase query execution work? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What tradeoff does Loki make compared to Elasticsearch for log search? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: Does Loki have a faster query path for simple substring matches vs. regex? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What's the gotcha with Loki's "like Prometheus, but for logs" approach? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why is the label index in Loki proportional to distinct label *combinations*, not log lines? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What is a burn rate in the context of SLO error budgets? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How is the burn-rate threshold calculated for a specific alert window? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does the slok/sloth tool compute four separate burn-rate thresholds instead of one? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why is an SLO alert based on a single threshold-and-window pair problematic? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What's the common mistake when teams first adopt SLOs? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What is the practical difference between a burn rate of 2.0× and 14.4×? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: How does multi-window alerting prevent paging on transient error spikes? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What are Google SRE's recommended window pairs for page-level and ticket-level alerts? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does the generated PromQL use `without ({{ .WindowLabel }})` on every `max()` call? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why is the full alert expression `(quick-short AND quick-long) OR (slow-short AND slow-long)` instead of a single pair? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What is alert fatigue and how does single-window alerting contribute to it? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens if you use a single-window alert and a real degradation is slow enough that it doesn't cross the short window's threshold? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What's the fundamental difference between RED and USE dashboards? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why can't you meaningfully apply RED to a node's CPU or USE to a stateless API endpoint? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does `mydurationpanel` use `histogram_quantile` instead of average duration? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: In the kubernetes-mixin, why does USE's saturation ratio use `cpuUsageByPod / cpuLimitsByPod`? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why do the RED panel functions have different `standardOptions.withUnit` values for each panel? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What's the common mistake when a team is asked to build a "RED dashboard" for infrastructure resources? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: Can a single Prometheus metric answer both a RED and a USE question? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does uniform 1% trace sampling throw away exactly the traces you need most? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does head-based sampling make its decision? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does tail-based sampling need to buffer every span? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What operational cost does tail-based sampling introduce that head-based doesn't? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: Can head-based and tail-based sampling coexist in the same pipeline? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens if `decision_wait` is too short for the slowest traces in your system? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: What's the gotcha with tail-based sampling in a multi-service trace? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does `[ThreadStatic]` break correlation across async boundaries? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does `Activity.Start()` automatically create parent-child links? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What is `Activity.Current` implemented as, mechanically? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens to `Activity.Current` if `ExecutionContext.SuppressFlow()` is called? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: Do concurrent `Task.WhenAll` branches share the same `Activity.Current` value? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why can't you just pass a correlation-ID parameter through every method instead of using `AsyncLocal`? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: Does a manually created `new Thread(...)` automatically flow `Activity.Current`? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does the "three pillars of observability" approach create friction during incident response? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does the Aspire Dashboard correlate traces, logs, and metrics? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does `TelemetryRepository` use `CircularBuffer` instead of an append-only store? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: How does the Aspire Dashboard notify the UI when new telemetry arrives? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Expert">
  <h3>Q: Why does clicking "View Logs" on a span show logs from the same causal unit of work, not just the same time window? <span class="qa-badge qa-expert">[Expert]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Intermediate">
  <h3>Q: What happens to old telemetry entries when the Aspire Dashboard's buffer is full? <span class="qa-badge qa-intermediate">[Intermediate]</span></h3>
  <div class="qa-a" markdown="1">
...
<div class="qa-item" data-diff="Beginner">
  <h3>Q: What is the structural advantage of one OTLP endpoint for all three signals vs. three separate ingestion pipelines? <span class="qa-badge qa-beginner">[Beginner]</span></h3>
  <div class="qa-a" markdown="1">
